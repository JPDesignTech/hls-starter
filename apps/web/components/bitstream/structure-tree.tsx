  ...
  return (
    <div className="select-none">
      ...
      {expanded && hasChildren && (
        <div className="ml-6 border-l border-white/10 pl-2">{children}</div>
      )}
    </div>
  );
}
    ...
    >
      ...
      <CardContent>
        <div className="space-y-2">
          ...
          {parameterSets &&
            (parameterSets.sps?.length ?? 0) +
              (parameterSets.pps?.length ?? 0) +
              (parameterSets.vps?.length ?? 0) >
              0 && (
              <div>
                <div
