...
import { ArrowLeft, FileVideo, List, Clock, HardDrive, Zap, FileText, Play, Download, ExternalLink } from 'lucide-react';
  ...
  useEffect(() => {
    async function fetchVideoData() {
      try {
        ...
        // Set master manifest as default
            ...
            <Card className="bg-white/10 backdrop-blur-lg border-white/20">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  {videoData.files?.length || 0} files generated
                </CardDescription>
              </CardHeader>
