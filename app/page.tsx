...
import { Upload, Video, Loader2, CheckCircle2, AlertCircle, Zap } from 'lucide-react';
        ...
        <Card className="mb-8 bg-white/10 backdrop-blur-lg border-white/20">
          <CardHeader>
            ...
            <CardDescription className="text-gray-300">
              Select a video file to upload and process for HLS streaming
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <CardContent className="pt-6">
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-300 max-w-md mx-auto">
                  Upload a video file to get started. BeemMeUp will automatically 
                  transcode it into multiple quality levels for adaptive streaming.
                </p>
              </div>
            </CardContent>
          </Card>
